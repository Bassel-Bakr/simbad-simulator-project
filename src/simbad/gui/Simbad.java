...
public class Simbad extends JFrame implements ActionListener {
    ...
    static int SIZEX = 800 + 50;
    static int SIZEY = 700 + 50;
    JMenuBar menubar;
...
//        setExtendedState(JFrame.MAXIMIZED_BOTH);
    ...
    private void createInternalFrames() {
        ...
        worldWindow.show();
        worldWindow.setLocation(250, 10);
        worldWindow.setSize(1100 / 2, 500);
        ...
        if (!backgroundMode) {
            ...
            controlWindow.show();
            controlWindow.setLocation(250, 520);
            controlWindow.setSize(1110 / 2, 200);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        new Simbad(new simbad.demo.ExplorationDemo(), backgroundMode);
    }
