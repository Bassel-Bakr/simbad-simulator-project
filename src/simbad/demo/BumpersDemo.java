...
public class BumpersDemo extends Demo {
    ...
    public BumpersDemo() {
        ...
        //add(new BumpersDemo.Robot(new Vector3d(4, 0, -4), "bump2"));
        //add(new BumpersDemo.Robot(new Vector3d(-4, 0, 4), "bump3"));
        //add(new BumpersDemo.Robot(new Vector3d(-4, 0, -4), "bump4"));
