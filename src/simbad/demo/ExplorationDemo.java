 ...
 *  $Revision: 1.4 $ 
 * $Source: /cvsroot/simbad/src/simbad/demo/ExplorationDemo.java,v $
 */
package simbad.demo;
 ...
 * A Bumping  demo.
 */
public class ExplorationDemo extends Demo {
    ...
    public class Robot extends Agent {
        ...
        int stepNo;
        int hit;
        double initialRotVelocity = Math.PI * 10;
...
//                   
            if (stepNo == 0) {
                setRotationalVelocity(initialRotVelocity * (hit + 1));
            } else {
            ...
            if (bumpers.oneHasHit()) {
                hit = hit - 1;
                // setRotationalVelocity(initialRotVelocity * 2);
                stepNo = 0;
...
//		add(new Box(new Vector3d(-2,0,-2),new Vector3f(3,1,2),this));
        ...
        add(new Robot(new Vector3d(0, 0, 0), "bump1"));
//        add(new ExplorationDemo.Robot(new Vector3d(4, 0, -4), "bump2"));
        //add(new ExplorationDemo.Robot(new Vector3d(-4, 0, 4), "bump3"));
        //add(new ExplorationDemo.Robot(new Vector3d(-4, 0, -4), "bump4"));
